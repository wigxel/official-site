...
export async function CraftsBlockComponent() {
  ...
  return (<div className='max-w-full overflow-hidden'>
    ...
    <div id={`carousel-${id}`} className='flex justify-between mt-[calc(120rem/16)] h-[680px] relative'>
...
function ServiceEntry({ entry }: { entry: Service }) {
  return <div className='flex-1 aspect-[514/680] min-w-[25vw] w-full max-w-[25%] flex flex-col gap-8 items-center'>
    <div className='flex flex-1 h-[calc(500rem/16)] bg-gray-800 min-w-[120px]' />
