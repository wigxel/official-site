...
export interface Page {
  ...
  layout: (LandingHero | WigxelCrafts | WigxelProjects | WigxelPartners | WigxelContactForm)[];
  meta?: {
    title?: string | null;
    /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "WigxelContactForm".
 */
export interface WigxelContactForm {
  layout: FormBlock[];
  id?: string | null;
  blockName?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "WigxelContactForm_select".
 */
export interface WigxelContactFormSelect<T extends boolean = true> {
  layout?:
    | T
    | {
